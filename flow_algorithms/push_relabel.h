...
namespace whfc_pr {
    ...
    public:
        ...
        size_t iterateOverEdges(const Node u, whfc::CutterState<Type>& cs, InHeIndex& he, const InHeIndex he_end) {
            size_t minLevel = n;
        ...
        size_t iterateOverPins(const Node u, whfc::CutterState<Type>& cs, PinIterator& pinIt, const PinIterator endIndex) {
        ...
        void dischargeNode(const Node u, whfc::CutterState<Type>& cs) {
        ...
        void dischargeEdgeNodeIn(const Node e_in, whfc::CutterState<Type>& cs) {
        ...
        void dischargeEdgeNodeOut(const Node e_out, whfc::CutterState<Type>& cs) {
        ...
        void pushRelabel(whfc::CutterState<Type>& cs, const size_t nm) {
            while (!nodes.empty()) {
                Node u = nodes.front();
                nodes.pop_front();
        ...
        void globalUpdate(whfc::CutterState<Type>& cs) {
            queue.clear();
            nodes.clear();
            inQueue.reset();
